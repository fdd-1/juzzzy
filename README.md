...
5️⃣ sku-review/ - 港澳SKU月度复盘自动化
作用：每月对港澳益智主订单做 SKU 维度复盘，自动匹配人群/套餐、计算 ASP/单课时价/占比，并与 SKU 测算预算对标
...
ASP、含积分/不含积分单课时价、套餐占比
人群维度：一续 / 多续
套餐维度：升舱 / 早鸟 / 全量限定 / 学情限定 / SVIP / 全量 / 其余
操作方式：
...
SKU复盘分析_{月份}.html - 可分享 HTML 报告
SKU精细对标_{月份}.xlsx - Excel 对标表
套餐明细_{月份}.csv - 套餐级聚合明细

6️⃣ 周报自动化/ - 周报数据处理与飞书发布
