"""扫描北极星 demo_network.har，列出所有 API 请求 + 关键请求体/响应体片段。"""
import json, sys, io
...
SKIP_HOSTS = ("dc.61draw.com", "h5data.3edc.cn", "reporter.61info.cn",
              "jic.talkingdata.com", "hm.baidu.com", "lf-cdn-tos.bytescm.com",
              "static.vipthink.cn", "static-ai.61info.com")
