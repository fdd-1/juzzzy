...
def generate_template_excel(node_results, budget_data, pkg_results,
    ...
    notes = [
        "=== 口径说明 ===",
        "1. BI报表筛选：订单支付时业绩归属人五级部门=港澳益智教学服务区 AND 区域等级=港澳",
...
<head>
<meta charset="UTF-8">
<title>{month_label}港澳SKU复盘分析报告</title>
<style>
...
<div class="container">
<div class="header">
<h1>{month_label}港澳SKU复盘分析报告</h1>
<p>分析对象：港澳地区益智续费套餐 | 节点取自正式池"池子节点2" | 生成时间：{now}</p>
</div>
