...
# BI 报表导出目录（服务绩效核算）
BI_REPORT_DIR = Path(r"C:\Users\fengjianyi\Desktop\服务绩效核算")

# 参考激励文件（上月，用于学习激励方案结构）
REFERENCE_INCENTIVE_FILE = Path(r"C:\Users\fengjianyi\Desktop\服务激励\4月\4月服务激励.xlsx")

# 输出目录
OUTPUT_DIR = Path(r"C:\Users\fengjianyi\Desktop\服务激励")
...
METRIC_SOURCES = {
    ...
    "首课及时跟进率": {
        ...
        "locate_by": {
            ...
            "row_match": {"B": "海外团队"},      # 找到海外团队行后，取下一行（数据行）
            "header_row": 2,
            "data_row_offset": 1,              # 匹配行 + 1 = 数据行（因合并单元格导致B/C为空）
        },
        "description": "海外思维学管服务指标 - 首课及时跟进率",
    },
    "首专及时跟进率": {
        "file_pattern": "*学管服务指标*",
        "sheet": "新建报表",
        ...
        "description": "海外思维学管服务指标 - 首专及时跟进率",
    },
    "语义点执行率加和": {
        "file_pattern": "*SOP执行*",
        "sheet": "汇总",
